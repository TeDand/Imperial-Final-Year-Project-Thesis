...
\begin{figure}[htb]%
    \centering
    \subfloat[\centering]{{\includegraphics[width=0.35\textwidth]{implementation/images/low_frame_repitition.png}}}%
    \subfloat[\centering]{{\includegraphics[width=0.35\textwidth]{implementation/images/high_frame_repitition.png}}}%
