...
\begin{table}[htb]
    ...
    \begin{tabular}{|| c | c | c | c | c ||}
        ...
        \hline
    \end{tabular}
    \caption{A table showing classification evaluation metrics of convolutional LSTM network on reconstructed DVS128 Gesture dataset.}
    \label{tab:conv_lstm_dvs128_recon_evaluation_metrics}
\end{table}
