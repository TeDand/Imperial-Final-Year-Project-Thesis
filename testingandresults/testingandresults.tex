...
The confusion matrices for the classification of the NMNIST dataset can be seen in \cref{fig:nmnist_c_matrices}.
...
\color{red} TODO: Fix and test custom convLSTM network to add to c\_matrix table. \color{black}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|| c | c | c ||}
        ...
        \hline \hline
        Conv3D Event Classifier          & 98.22\%   &   \color{red} 47.22\% \color{black}    \\
        \hline
